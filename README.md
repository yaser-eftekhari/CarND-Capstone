...
### Team member section
Since I had a pretty slow machine, I checked out **```optimization```** branch. In this branch the code is optimized to be able to run on slower machines like mine. Lots of unnecessary code has been removed and the critical parts of the code run based on frequency and not even driven.

If you are interested, please checkout that branch and see the readme file for more detailed information about how the code has been implemented.
